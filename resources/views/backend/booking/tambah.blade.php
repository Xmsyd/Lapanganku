...
<form action=" {{ route('bookings.create') }} " method="POST">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <input id="user_id" name="user_id" placeholder="ID user" type="text" class="form-control">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <input id="lapangan_id" name="lapangan_id" placeholder="ID Lapangan" type="text" class="form-control">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <input id="tanggal" name="tanggal" placeholder="Tanggal" type="text" class="form-control">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <select id="jam_mulai" name="jam_mulai" required="required" class="custom-select">
                <option value="Pilih Jam Mulai">Pilih Jam Mulai</option>
    ...
    <!-- Jam Akhir -->
    <div class="form-group row">
        <label for="jam_akhir" class="col-4 col-form-label">Jam_Akhir</label>
        <div class="col-8">
