...
@section('content')
<form action=" {{ route('lapangan.create') }} " method="POST">
    @csrf
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <div class="input-group">
                ...
                <input id="nama_lap" name="nama_lap" type="text" class="form-control" required="required">
            </div>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <div class="input-group">
                ...
                <textarea id="lokasi" name="lokasi" type="text" class="form-control" required="required"></textarea>
            </div>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <div class="input-group">
                ...
                <input id="harga_perjam" name="harga_perjam" type="number" step="0.01" class="form-control" required="required">
            </div>
        </div>
    </div>
